...
namespace RevCookBookASP.Controllers
{
    public class LanguagesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("LanguageId,LanguageCode")] Language language)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("LanguageId,LanguageCode")] Language language)
        {
